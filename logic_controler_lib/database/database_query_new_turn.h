#ifndef DATABASE_QUERY_NEW_TURN_H
#define DATABASE_QUERY_NEW_TURN_H
#include <QSqlQuery>
#include <QSqlError>
#include <QSqlRecord>
...
class DatabaseQueryNewTurn  : public I_QueryTemplate
{
public:
...
#endif // DATABASE_QUERY_NEW_TURN_H
